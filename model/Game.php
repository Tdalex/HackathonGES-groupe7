 ...
 * @ORM\Table(name="Game", indexes={@ORM\Index(name="fk_Game_JobApplication1_idx", columns={"IdJobApplication"}), @ORM\Index(name="fk_Game_User1_idx", columns={"IdUser"}), @ORM\Index(name="fk_Game_Question1_idx", columns={"LastQuestion"})})
 */
class Game
{
    /**
     ...
     * @ORM\JoinColumn(name="LastQuestion", referencedColumnName="IdQuestion", nullable=false)
     */
    protected $question;
    ...
    {
        return array('IdGame', 'Last_play', 'Score', 'IdJobApplication', 'Is_finished', 'IdUser', 'LastQuestion');
    }
}